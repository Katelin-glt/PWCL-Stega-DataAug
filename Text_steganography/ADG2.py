...
parser.add_argument('-generate-num', type=int, default=None, required=True,\
                    help='The number of generated stego text [default:None]')
parser.add_argument('-idx-gpu', type=str, default=None, required=True,\
...
def main():
    ...
    with torch.no_grad():
        ...
        # write files
        with open('stego/' + DATASET + '/adg_2.txt', 'a', encoding='utf8') as f:
